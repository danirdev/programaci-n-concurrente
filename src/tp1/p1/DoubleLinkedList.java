...
public class DoubleLinkedList<ELEMENT> implements ILinkedList<ELEMENT> {
		...
		public void insertarPosicion(ELEMENT elemento, int posicion) {
			...
			Node<ELEMENT> nuevoNodo = new Node<>(elemento);
			Node<ELEMENT> actual = this.head;
			// RECORREMOS HASTA LA POSICION QUE QUEREMOS LLEGAR
			for (int i = 1; i < posicion; i++) {
				actual = actual.next;
			}
			// ENLAZAMOS EL NUEVO NODO CON EL ACTUAL Y EL SIGUIENTE
