# Actividad 2: Cuenta Sueldo

A partir de la clase definida en el ejemplo anterior, cree una nueva clase `CuentaSueldo`, que herede de `Cuenta` y posea los siguientes atributos propios:
